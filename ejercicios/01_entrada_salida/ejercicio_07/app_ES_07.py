...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        resultado = f"El resultado de la suma es  {(operador_a) + (operador_b)}"
    ...
    def btn_restar_on_click(self):
        ...
        resultado = f"El resultado de la resta es  {(operador_a) - (operador_b)}"
    ...
    def btn_multiplicar_on_click(self):
        ...
        resultado = f"El resultado de la multiplicacion es  {(operador_a) * (operador_b)}"
    ...
    def btn_dividir_on_click(self):
        ...
        resultado = f"El resultado de la división es  {(operador_a) / (operador_b)}"
